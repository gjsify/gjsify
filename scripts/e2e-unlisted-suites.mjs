...
export const E2E_UNLISTED_SUITES = {
    ...
    'react-native-devtools': [
        ...
        'wrong thing. IT RUNS INSTEAD in main.yml’s `e2e` job (shard 1), under the same wrapper',
        'and the same env the `examples` job puts around the showcase smoke launch, with',
        '`GJSIFY_E2E_REQUIRE=react-native-devtools` — so a container missing any of its eleven',
