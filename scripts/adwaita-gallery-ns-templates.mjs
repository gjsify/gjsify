...
export const ADWAITA_GALLERY_NS_TEMPLATES = [
    ...
    },
    {
        ...
        root: {
            ...
            children: [
                { tag: 'GtkButton', props: { text: 'Pill', cssClasses: 'pill' } },
                { tag: 'GtkButton', props: { text: 'Suggested', cssClasses: 'suggested-action' } },
                { tag: 'GtkButton', props: { text: 'Delete', cssClasses: 'destructive-action' } },
                { tag: 'GtkButton', props: { text: 'Flat', cssClasses: 'flat' } },
            ],
        },
    },
    // ---------------------------------------------------------------- controls
    ...
    },
    {
        ...
        root: {
            tag: 'AdwHeaderBar',
            children: [
                { tag: 'GtkButton', slot: 'startBox', props: { text: '‹', cssClasses: 'flat' } },
                {
                    tag: 'AdwWindowTitle',
                    slot: 'titleWidget',
                    props: { title: 'Text Editor', subtitle: 'notes.md' },
                },
                { tag: 'GtkButton', slot: 'endBox', props: { text: '≡', cssClasses: 'flat' } },
            ],
        },
    },
    {
    ...
    },
    {
        ...
        root: {
            ...
            children: [
                { tag: 'GtkButton', props: { text: 'Design', cssClasses: 'pill' } },
                { tag: 'GtkButton', props: { text: 'Adwaita', cssClasses: 'pill' } },
                { tag: 'GtkButton', props: { text: 'GNOME', cssClasses: 'pill' } },
                { tag: 'GtkButton', props: { text: 'GTK', cssClasses: 'pill' } },
                { tag: 'GtkButton', props: { text: 'TypeScript', cssClasses: 'pill' } },
                { tag: 'GtkButton', props: { text: 'Storybook', cssClasses: 'pill' } },
            ],
        },
    },
    // ------------------------------------------------------------ presentation
