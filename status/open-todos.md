...
56 rule files and 30
reality probes, all 86 goldens byte-equal, `SHADOW_DIVERGENCES` empty, and 21 refused `.blp` each
...
fall outside `SharedNode` than the census of the thirty real files found, and the translatable
