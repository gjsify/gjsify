...
cap plus an EXACT per-file ceiling. This file is still over the 20 KB target, so the gate
catches REGROWTH instead of claiming the target is met. Exact means
