...
GJSify welcomes contributions! This page describes how we port new Node.js or Web APIs to GJS. It is a strict test-driven workflow that keeps both Node.js and GJS implementations honest.
...
4. **Test on GJS**: `gjsify run test:gjs`, and expect failures, then fix the GJSify implementation
