...
What is still missing is the Windows `.msi` and notarisation. The two operating
systems also differ in what an unsigned artifact costs you: Gatekeeper BLOCKS an
