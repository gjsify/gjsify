---
title: Ship your app
description: Turn a built GJS app into something other people can install. One command gives you a .deb, an .rpm and a Flatpak bundle; this page also points at the one-line installer, self-executing bundles and dlx.
---
...
where to move them. The app metadata — `name`, `summary`, `developer`,
...
macOS bundles and Windows installers are planned but not here yet; a `.dmg` is
