...
<AdwWidget title="Gtk.Button" blueprint="gtk/button.blp">
  ...
  <Fragment slot="webloader">
    ...
    import tree from './button.blp?shared-tree';

    const { root: box } = mountSharedTree(tree);
    const deleteButton = box.querySelector<Gtk.Button>('#delete_button')!;
  ...
  <Fragment slot="nativescriptloader">
    ...
    const box = build(tree) as Adw.WrapBox;
...
<AdwWidget title="Gtk.MenuButton" blueprint="gtk/menu-button.blp">
  ...
  <Fragment slot="webloader">
    ```ts
    import { mountSharedTree, type Gtk } from '@gjsify/adwaita-web';
    import tree from './menu-button.blp?shared-tree';

    const { root } = mountSharedTree(tree);
    const menuButton = root as Gtk.MenuButton;
  ...
  <Fragment slot="nativescriptloader">
    ...
    const menuButton = build(tree) as Gtk.MenuButton;
