...
<CommandTabs title="Build the bundle">
  ...
  <Fragment slot="deno">
    ```bash
    deno run -A npm:@gjsify/cli@latest build src/index.ts --outfile dist/index.js
    # (--globals auto is the default — no flag needed)
    ```
  </Fragment>
</CommandTabs>
...
<CommandTabs title="Run the bundle">
  ...
  <Fragment slot="deno">
    ```bash
    deno run -A npm:@gjsify/cli@latest run dist/index.js
    ```
  </Fragment>
</CommandTabs>
...
<CommandTabs title="Export the environment">
  ...
  <Fragment slot="deno">
    ```bash
    eval $(deno run -A npm:@gjsify/cli@latest info --export)
    gjs -m dist/index.js
    ```
  </Fragment>
</CommandTabs>
