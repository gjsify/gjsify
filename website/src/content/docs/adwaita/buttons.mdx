---
title: Buttons
description: "Adwaita buttons: icon-plus-label content, the style classes, split buttons and toggle groups. Live preview plus the code for GJS, Blueprint, the web and NativeScript."
---
...
happens. This page covers the four things you will want from one. Give it an
**icon plus a label**, apply a **style class** to set its shape and intent, use a
**split button** to pair an action with a menu of alternatives, or a **toggle
group** when a row of linked buttons should act as a single-choice selector.
