...
<AdwWidget title="Adw.NavigationSplitView" padding="flush" stage="height: 340px; width: 100%; display: flex; overflow: hidden;">
  ...
  <Fragment slot="nativescript">
    ...
    sidebar.add_top_bar(new Adw.HeaderBar({ title: 'Mailboxes' }));
    sidebar.set_content(sidebarList);
    ...
    content.add_top_bar(new Adw.HeaderBar({ title: 'All Mail' }));
    content.set_content(status);

    const view = new Adw.NavigationSplitView();
    view.set_sidebar(sidebar);
...
<AdwWidget title="Adw.OverlaySplitView" padding="flush" stage="height: 340px; width: 100%; display: flex; overflow: hidden;">
  ...
  <Fragment slot="nativescript">
    ...
    const sidebar = new Adw.ToolbarView();
    sidebar.add_top_bar(new Adw.HeaderBar({ styleClasses: 'flat' }));
    sidebar.set_content(sidebarList);
    ...
    const view = new Adw.OverlaySplitView();
    view.set_sidebar(sidebar);
    view.set_content(content);
    view.showSidebar = true;
...
<AdwWidget title="Adw.NavigationView" padding="flush" stage="height: 340px; width: 100%; display: flex; overflow: hidden;">
  ...
  <Fragment slot="nativescript">
    ...
    detail.add_top_bar(new Adw.HeaderBar({ title: 'Ada Lovelace' }));
    detail.set_content(detailStatus);
    ...
    root.add_top_bar(new Adw.HeaderBar({ title: 'Contacts' }));
    root.set_content(open);
...
<AdwWidget title="Adw.Sidebar" padding="flush" stage="height: 340px; width: 100%; display: flex; overflow: hidden; border: 1px solid var(--card-shade-color); border-radius: var(--card-radius, 12px);">
  ...
  <Fragment slot="nativescript">
    ...
    const box = new Gtk.Box({ orientation: 'horizontal' });
    box.append(sidebar);
    box.append(status);
    ```
  </Fragment>
...
<AdwWidget title="Adw.BottomSheet" padding="flush" stage="height: 340px; width: 100%; display: flex; overflow: hidden; position: relative;">
  <Fragment slot="preview">
    ...
    <adw-bottom-sheet open modal can-close style="flex: 1;">
      <adw-bottom-sheet-content>
        <div style="display: flex; align-items: center; justify-content: center; width: 100%; height: 100%;">
          <gtk-button pill suggested>Toggle sheet</gtk-button>
        </div>
      </adw-bottom-sheet-content>
  ...
  <Fragment slot="nativescript">
    ...
    const sheet = new Adw.BottomSheet({ open: true, canClose: true });
    ...
    box.append(new Gtk.Label({ label: 'Share track', styleClasses: 'title-2' }));
