...
<AdwWidget title="Adw.NavigationSplitView" padding="flush" stage="height: 340px; width: 100%; display: flex; overflow: hidden;">
  ...
  <Fragment slot="nativescript">
    ...
    const sidebarToolbar = new Adw.ToolbarView();
    sidebarToolbar.add_top_bar(new Adw.HeaderBar({ title: 'Mailboxes' }));
    sidebarToolbar.content = sidebarList;
    ...
    const contentToolbar = new Adw.ToolbarView();
    contentToolbar.add_top_bar(new Adw.HeaderBar({ title: 'All Mail' }));
    contentToolbar.content = status;

    const view = new Adw.NavigationSplitView({ sidebar: sidebarToolbar, content: contentToolbar, showContent: true });
    ```
  </Fragment>
</AdwWidget>
...
<AdwWidget title="Adw.NavigationView" padding="flush" stage="height: 340px; width: 100%; display: flex; overflow: hidden;">
  ...
  <Fragment slot="nativescript">
    ...
    const page = (title: string, body: Adw.StatusPage | Gtk.Button) => {
        const toolbar = new Adw.ToolbarView();
        toolbar.add_top_bar(new Adw.HeaderBar({ title }));
        toolbar.content = body;
        return toolbar;
    };
