---
title: Presentation
description: "Adwaita presentation widgets: avatar, banner, spinner, status page and window title. Live preview plus the code for GJS, Blueprint, the web and NativeScript."
---
...
**spinner** while work is running, a **status page** for an empty or error state,
and a **window title** in a header bar.
