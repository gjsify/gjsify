...
<AdwWidget title="Adw.ShortcutLabel">
  <Fragment slot="preview">
    <div style="display:flex;flex-wrap:wrap;gap:24px;justify-content:center;align-items:center;">
      <adw-shortcut-label accelerator="&lt;Control&gt;C" disabled-text="Disabled"></adw-shortcut-label>
      <adw-shortcut-label accelerator="&lt;Shift&gt;A Home" disabled-text="Disabled"></adw-shortcut-label>
      <adw-shortcut-label accelerator="&lt;Alt&gt;1...9" disabled-text="Disabled"></adw-shortcut-label>
      <adw-shortcut-label accelerator="Control_L&amp;Control_R" disabled-text="Disabled"></adw-shortcut-label>
    </div>
  </Fragment>
  <Fragment slot="gjs">
    ```ts
