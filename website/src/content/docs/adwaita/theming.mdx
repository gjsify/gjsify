...
**`AdwStyleManager:accent-color` is read-only** — measured on libadwaita 1.9.3,
assigning to it throws *Property AdwStyleManager.accent-color is not writable*. So
the property is a report, never a setting.
