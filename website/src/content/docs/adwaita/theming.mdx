...
## On the desktop, the accent is not yours to set

A native GTK app takes its accent from the user's GNOME setting through
`AdwStyleManager`. If your app renders on both, set the token for the web and
leave the desktop alone: someone who picked an accent in Settings expects your app
to use it.
