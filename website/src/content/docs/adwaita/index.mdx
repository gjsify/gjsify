...
<div class="adw-gallery-grid">
  ...
  <AdwGalleryCard title="Buttons" href="/gjsify/adwaita/buttons/" description="Button content, the style classes, split buttons and linked toggle groups.">
    <Fragment slot="preview">
  ...
  <AdwGalleryCard title="View Switching" href="/gjsify/adwaita/view-switching/" description="View switchers, tab views and carousels over a stack that shows one page at a time.">
    <Fragment slot="preview">
  ...
  <AdwGalleryCard title="Presentation" href="/gjsify/adwaita/presentation/" description="Avatars, banners, spinners, status pages and window titles for showing state.">
    <Fragment slot="preview">
