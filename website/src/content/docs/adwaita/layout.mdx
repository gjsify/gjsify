...
and these four blocks are the only ones with a
[`@gjsify/react-native`](/gjsify/frameworks/react-native/) tab beside them. That tab
renders a GTK window, not a phone screen, which is why it is not the NativeScript one;
the [React Native page](/gjsify/frameworks/react-native/#adwaita-widgets) says what
