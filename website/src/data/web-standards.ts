...
export const webStandardsCategories: readonly WebStandardCategory[] = [
	...
	},
	{
		...
		standards: [
			...
			{ name: "Origin Private File System", status: "out-of-scope", note: "Browser sandbox; GTK uses Gio.File directly" },
		],
	},
	{
	...
	},
	{
		name: "Crypto",
		standards: [
			{ name: "Web Crypto", status: "full", pkg: "@gjsify/webcrypto" },
		],
	},
	{
		name: "Events & Async",
		standards: [
			...
			{ name: "Prioritized Task Scheduling", status: "missing", note: "scheduler.postTask — GLib idle could back" },
		],
	},
	{
		name: "Workers",
		standards: [
			{ name: "Web Workers", status: "partial", pkg: "@gjsify/worker_threads", note: "file-based; no DOM-Worker shim" },
	...
	},
	{
		name: "Multimedia",
		standards: [
			{ name: "Web Audio", status: "partial", pkg: "@gjsify/webaudio", note: "Phase 1: AudioContext + Source + Gain" },
	...
	},
	{
		...
		standards: [
			...
			{ name: "Custom Elements + Shadow DOM", status: "missing", note: "Needed for Adwaita component composition" },
	...
	},
	{
		...
		standards: [
			...
			{ name: "Web USB / Serial / HID / NFC", status: "out-of-scope", note: "Native apps use libusb/udev directly" },
		],
	},
	{
		name: "Files & Data",
