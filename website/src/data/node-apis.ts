...
export const nodeApiCategories: readonly NodeApiCategory[] = [
	...
	},
	{
		name: "Crypto",
		apis: [
			{ name: "crypto", status: "full", backed: "GLib.Checksum + Hmac" },
		],
	},
	{
		name: "Concurrency",
		apis: [
			...
			{ name: "worker_threads", status: "partial", backed: "Gio.Subprocess + @gjsify/sab-native", note: "Cross-process IPC, file-based workers" },
	...
	},
	{
		name: "Storage",
		apis: [
			{ name: "sqlite", status: "partial", backed: "Gda 6.0 (SQLite provider)" },
		],
	},
	{
		name: "Compute",
		apis: [
			...
			{ name: "v8", status: "partial", note: "Wire-format v15 serialize/deserialize; no heap snapshot or CPU profile" },
		],
	},
];
