...
> napi.yml's `macos` job builds, load-tests and uploads it as a workflow artifact for a release to ship; no job commits it back into this repo
>
...
The **darwin-arm64** native artifacts of [`@gjsify/napi`](https://www.npmjs.com/package/@gjsify/napi) — a shared
