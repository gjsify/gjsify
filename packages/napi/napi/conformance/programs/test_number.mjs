...
export default async function run(h) {
    ...
    for (const n of [
        0.0, -0.0, -Math.pow(2, 31), Math.pow(2, 31) - 1, 4294967297, 4294967296, 4294967295,
        4294967296 * 5 + 3, Number.MIN_SAFE_INTEGER, Number.MAX_SAFE_INTEGER,
        -Math.pow(2, 63) + (Math.pow(2, 9) + 1), Math.pow(2, 63) - (Math.pow(2, 9) + 1),
        -Number.MIN_VALUE, Number.MIN_VALUE, -Number.MAX_VALUE, Number.MAX_VALUE,
        -Math.pow(2, 63) + Math.pow(2, 9), Math.pow(2, 63) - Math.pow(2, 9),
        Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY, Number.NaN,
    ])
    ...
    for (const n of [
        0.0, -0.0, Number.MIN_SAFE_INTEGER, Number.MAX_SAFE_INTEGER,
        -Math.pow(2, 63) + (Math.pow(2, 9) + 1), Math.pow(2, 63) - (Math.pow(2, 9) + 1),
        -Number.MIN_VALUE, Number.MIN_VALUE, -Number.MAX_VALUE, Number.MAX_VALUE,
        -Math.pow(2, 63) + Math.pow(2, 9), Math.pow(2, 63) - Math.pow(2, 9),
        Number.POSITIVE_INFINITY, Number.NEGATIVE_INFINITY, Number.NaN,
