...
// Vendored from refs/node/src/js_native_api_types.h (Node.js contributors, MIT).
// Copied unmodified (apart from this attribution header) so the @gjsify/napi
// shim compiles standalone against the exact Node-API ABI it implements.
