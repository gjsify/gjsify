# @gjsify/terminal-native-linux-ppc64

The **linux-ppc64** native artifacts of [`@gjsify/terminal-native`](https://www.npmjs.com/package/@gjsify/terminal-native) — a shared
