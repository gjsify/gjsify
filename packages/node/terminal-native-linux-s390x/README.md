# @gjsify/terminal-native-linux-s390x


The **linux-s390x** native artifacts of [`@gjsify/terminal-native`](https://www.npmjs.com/package/@gjsify/terminal-native) — a shared
