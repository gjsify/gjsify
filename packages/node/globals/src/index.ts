...
// `globalThis`. Use `@gjsify/node-globals/register` (or rely on the
// gjsify esbuild plugin's auto-injection) to actually set
// process, Buffer, setImmediate/clearImmediate, btoa/atob, structuredClone,
