# @gjsify/http-soup-bridge-linux-arm64

The **linux-arm64** native artifacts of [`@gjsify/http-soup-bridge`](https://www.npmjs.com/package/@gjsify/http-soup-bridge) — a shared
