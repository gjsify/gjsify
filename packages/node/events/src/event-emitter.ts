...
export class EventEmitter {
    ...
    static readonly errorMonitor: unique symbol = Symbol(
        'events.errorMonitor',
    ) as unknown as typeof EventEmitter.errorMonitor;
...
// ES class methods are non-enumerable; Node.js uses prototype assignment, making them enumerable.
// socket.io v4 iterates Object.keys(EventEmitter.prototype) to build proxy methods.
{
    ...
    Object.defineProperty(EventEmitter.prototype, '_maxListeners', {
        enumerable: true,
        configurable: true,
        writable: true,
        value: undefined,
