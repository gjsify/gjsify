 ...
 * @param [def] If specified, will be returned for invalid values
 * @returns
 */
function parseFileMode(value: any, name: string, def?: number) {
  value ??= def;
...
const validateObject = hideStackFrames((value: any, name: string, options?: ValidateObjectOptions | null) => {
...
const validateOneOf = hideStackFrames(
  (value: any, name: string, oneOf: any[]) => {
...
function validatePort(port: number | string, name = "Port", allowZero = true) {
  if (
...
const validateArray = hideStackFrames(
  (value: any, name: string, minLength = 0) => {
