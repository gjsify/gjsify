...
import { validateInt32, validateString } from "../validators.js";
...
export class DiffieHellman {
  ...
  constructor(
    ...
    if (typeof sizeOrKey !== "number") {
      sizeOrKey = toBuf(sizeOrKey as string, keyEncoding as BufferEncoding);
    }
    ...
    if (!generator) {
      ...
      generator = toBuf(generator, genEncoding as BufferEncoding);
