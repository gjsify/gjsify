# @gjsify/terminal-native-linux-arm64


The **linux-arm64** native artifacts of [`@gjsify/terminal-native`](https://www.npmjs.com/package/@gjsify/terminal-native) — a shared
