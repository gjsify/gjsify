...
export class Duplex_ extends Readable_ {
    ...
    constructor(opts?: DuplexOptions) {
        ...
        this.writableHighWaterMark =
            opts?.highWaterMark ?? opts?.writableHighWaterMark ?? getDefaultHighWaterMark(this.writableObjectMode);
        ...
        if (opts?.write)
            this._writeImpl = opts.write as unknown as (this: Duplex_, c: unknown, e: string, cb: ErrCallback) => void;
