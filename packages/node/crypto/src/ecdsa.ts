...
import { mod, modInverse, scalarMul, pointAdd, CURVES, CURVE_ALIASES, type ECPoint, type CurveParams } from './ecdh.js';
 ...
 */
function rfc6979(hashAlgo: string, privKey: bigint, msgHash: Uint8Array, curve: CurveParams): bigint {
 ...
 */
export function ecdsaSign(hashAlgo: string, privKeyBytes: Uint8Array, data: Uint8Array, curveName: string): Uint8Array {
