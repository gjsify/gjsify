// Ported from refs/webkit/Source/ThirdParty/libwebrtc/Source/third_party/boringssl/src/third_party/wycheproof_testvectors/x25519_test.json
// Original: Apache-2.0, Copyright (c) 2017 Google Inc. (Project Wycheproof)
// Modifications: flattened to [tcId, private, public, shared, zeroSharedSecret] rows.
//
// 518 vectors. `zeroSharedSecret` rows use a low-order public key: RFC 7748
// § 6.1 lets an implementation reject them, and OpenSSL (Node) does — so does GJS.

export type X25519Vector = [tcId: number, priv: string, pub: string, shared: string, zeroSharedSecret: boolean];

export const WYCHEPROOF_X25519: X25519Vector[] = [
    [
        1,
