...
function emsaPssEncode(mHash: Uint8Array, emBits: number, hashAlgo: string, saltLength: number): Uint8Array {
 ...
 */
export function rsaPssSign(hashAlgo: string, privKeyPem: string, data: Uint8Array, saltLength: number): Uint8Array {
