# @gjsify/http-soup-bridge-linux-ppc64


The **linux-ppc64** native artifacts of [`@gjsify/http-soup-bridge`](https://www.npmjs.com/package/@gjsify/http-soup-bridge) — a shared
...
`cpu: ["ppc64"]`, so your package manager installs the one build that fits your
