...
function indexToTypedArray(index: number): TypedArrayCtor | undefined {
    switch (index) {
        ...
        case 9:
            return DataView as unknown as TypedArrayCtor;
        case 10:
            return Buffer as unknown as TypedArrayCtor;
        case 11:
            return BigInt64Array as unknown as TypedArrayCtor;
        case 12:
            return BigUint64Array as unknown as TypedArrayCtor;
    }
    return undefined;
}
...
export class Serializer {
    ...
    writeValue(value: unknown): void {
        ...
        if (value === undefined) {
            ...
            throw new this._getDataCloneError(`${String(value)} could not be cloned.`);
        }
    }
    ...
    _writeHostObject(_obj: object): void {
        throw new this._getDataCloneError(`Unserializable host object: ${Object.prototype.toString.call(_obj)}`);
    }
    ...
    override _readHostObject(): NodeJS.ArrayBufferView {
        ...
        if (typeIndex === 10) {
            ...
            this.buffer.copy(
                ...
                this.buffer.byteOffset + byteOffset + byteLength,
            );
            return b;
        }
