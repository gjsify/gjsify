# @gjsify/http-soup-bridge-linux-x64

The **linux-x64** native artifacts of [`@gjsify/http-soup-bridge`](https://www.npmjs.com/package/@gjsify/http-soup-bridge) — a shared
