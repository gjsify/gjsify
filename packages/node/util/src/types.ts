...
isArrayBufferToString.working = (
  ...
  isArrayBufferToString(new ArrayBuffer(1))
);
...
export function isSharedArrayBuffer(value) {
  ...
  if (typeof (isSharedArrayBufferToString as any).working === 'undefined') {
    (isSharedArrayBufferToString as any).working = isSharedArrayBufferToString(new SharedArrayBufferCopy(1));
  }

  return (isSharedArrayBufferToString as any).working
...
export function isExternal(value: any) {
  warnNotImplemented('node.util.types.isExternal');
  return false;
}

export function isModuleNamespaceObject(value: any) {
