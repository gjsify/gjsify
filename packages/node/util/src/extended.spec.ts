...
export default async () => {
    ...
    await describe('util.aborted', async () => {
        ...
        await it('returns a rejected Promise when signal is not an AbortSignal', async () => {
            ...
            try {
                await util.aborted(null as unknown as AbortSignal, {});
            } catch (e) {
                caught = e;
            }
            ...
            caught = null;
            try {
                await util.aborted({} as AbortSignal, {});
            } catch (e) {
                caught = e;
            }
            expect(caught).toBeTruthy();
        ...
        await it('returns a rejected Promise when resource is not a non-null object', async () => {
            ...
            let caught: unknown = null;
            try {
                await util.aborted(ctrl.signal, null as unknown as object);
            } catch (e) {
                caught = e;
            }
            expect(caught).toBeTruthy();
            ...
            caught = null;
            try {
                await util.aborted(ctrl.signal, 'not-an-object' as unknown as object);
            } catch (e) {
                caught = e;
            }
            expect(caught).toBeTruthy();
