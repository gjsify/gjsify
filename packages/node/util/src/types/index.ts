...
const _getSharedArrayBufferByteLength =
...
export function isRegExp(value: unknown): value is RegExp {
    return (
        isObjectLike(value) && value[Symbol.toStringTag] === undefined && _toString.call(value) === '[object RegExp]'
    );
}
...
export function isArgumentsObject(value: unknown): value is IArguments {
    return (
        isObjectLike(value) && value[Symbol.toStringTag] === undefined && _toString.call(value) === '[object Arguments]'
    );
}
