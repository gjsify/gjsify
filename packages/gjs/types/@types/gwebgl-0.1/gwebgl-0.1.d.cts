...
export const UNPACK_FLIP_Y_WEBGL: number
export const UNPACK_PREMULTIPLY_ALPHA_WEBGL: number
export const UNPACK_COLORSPACE_CONVERSION_WEBGL: number
export const CONTEXT_LOST_WEBGL: number
export const BROWSER_DEFAULT_WEBGL: number
export const VERTEX_ATTRIB_ARRAY_DIVISOR_ANGLE: number
export const UNMASKED_VENDOR_WEBGL: number
export const UNMASKED_RENDERER_WEBGL: number
export const MAX_DRAW_BUFFERS_WEBGL: number
export const MAX_TEXTURE_MAX_ANISOTROPY_EXT: number
export const TEXTURE_MAX_ANISOTROPY_EXT: number
export const STENCIL_INDEX: number
export const VERSION: number
export const IMPLEMENTATION_COLOR_READ_TYPE: number
export const IMPLEMENTATION_COLOR_READ_FORMAT: number
export module WebGLRenderingContextBase {
...
export class WebGLRenderingContextBase extends GObject.Object {
...
export module WebGLRenderingContext {

    // Constructor properties interface

    export interface ConstructorProperties extends WebGLRenderingContextBase.ConstructorProperties {
...
export interface WebGLRenderingContextBaseClass {
}

export abstract class WebGLRenderingContextBaseClass {
...
export interface WebGLRenderingContextBasePrivate {
}

export class WebGLRenderingContextBasePrivate {
...
export interface WebGLRenderingContextClass {
}

export abstract class WebGLRenderingContextClass {
...
export interface WebGLRenderingContextPrivate {
}

export class WebGLRenderingContextPrivate {
