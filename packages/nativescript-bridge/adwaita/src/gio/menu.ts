...
// surface had was the name an author reaches for. `@gjsify/adwaita-core` is the portable
// model's home and cannot host this class — its menu module is deliberately free of any
// GIR spelling — so the website gallery wrote the same menu twice:
//
