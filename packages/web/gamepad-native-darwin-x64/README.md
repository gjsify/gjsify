# @gjsify/gamepad-native-darwin-x64
...
> prebuilds.yml's `build-prebuilds-macos` job builds, tests and load-tests it; `commit-prebuilds` lands the first artifact on main after this package merges
>
...
The **darwin-x64** native artifacts of [`@gjsify/gamepad-native`](https://www.npmjs.com/package/@gjsify/gamepad-native) — a shared
