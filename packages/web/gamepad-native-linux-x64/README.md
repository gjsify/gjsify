# @gjsify/gamepad-native-linux-x64
...
> prebuilds.yml's `build-prebuilds` job (linux-x64 leg) builds and tests it; `commit-prebuilds` lands the first artifact on main after this package merges
>
...
The **linux-x64** native artifacts of [`@gjsify/gamepad-native`](https://www.npmjs.com/package/@gjsify/gamepad-native) — a shared
