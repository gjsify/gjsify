...
:root {
  ...
  --icon-go-previous: ${toDataUri(goPreviousSymbolic)};
  --icon-go-next: ${toDataUri(goNextSymbolic)};
  --icon-view-refresh: ${toDataUri(viewRefreshSymbolic)};
  --icon-open-menu: ${toDataUri(openMenuSymbolic)};
  --icon-go-home: ${toDataUri(goHomeSymbolic)};
}
`;
