...
// Emit the .js sibling too: src/index.ts imports './styles.generated.js', and
// bundlers (and GJS) resolve a real .js in preference to compiling the .ts — so
// if only the .ts were regenerated, a stale .js left by an earlier lib build
// would shadow it and SCSS changes would silently not reach the bundle.
writeFileSync(resolve(pkgRoot, 'src', 'styles.generated.js'), stylesModule);
console.log('✓ Generated src/styles.generated.ts + styles.generated.js');
