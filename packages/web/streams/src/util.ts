...
export function typedArrayConstructorByTag(tag: string | undefined): ArrayBufferViewCtor | undefined {
    switch (tag) {
        case 'Int8Array':
            return Int8Array as unknown as ArrayBufferViewCtor;
        case 'Uint8Array':
            return Uint8Array as unknown as ArrayBufferViewCtor;
        case 'Uint8ClampedArray':
            return Uint8ClampedArray as unknown as ArrayBufferViewCtor;
        case 'Int16Array':
            return Int16Array as unknown as ArrayBufferViewCtor;
        case 'Uint16Array':
            return Uint16Array as unknown as ArrayBufferViewCtor;
        case 'Int32Array':
            return Int32Array as unknown as ArrayBufferViewCtor;
        case 'Uint32Array':
            return Uint32Array as unknown as ArrayBufferViewCtor;
        case 'Float32Array':
            return Float32Array as unknown as ArrayBufferViewCtor;
        case 'Float64Array':
            return Float64Array as unknown as ArrayBufferViewCtor;
        case 'BigInt64Array':
            return typeof BigInt64Array !== 'undefined' ? (BigInt64Array as unknown as ArrayBufferViewCtor) : undefined;
        case 'BigUint64Array':
            return typeof BigUint64Array !== 'undefined'
                ? (BigUint64Array as unknown as ArrayBufferViewCtor)
                : undefined;
        default:
            return undefined;
    }
...
export function iteratorNext(
    iteratorRecord: { iterator: unknown; nextMethod: Function; done: boolean },
    value?: unknown,
) {
    let result;
    if (value === undefined) {
