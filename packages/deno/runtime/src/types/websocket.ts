...
// Based on https://github.com/denoland/deno/blob/main/ext/websocket/lib.deno_websocket.d.ts
...
/** @category Web Sockets */
export interface CloseEvent extends Event { // TODO class
 ...
 * @category Web Sockets
 */
export interface WebSocket extends EventTarget { // TODO class
