 ...
 *
 * @category Sub Process */
export interface Process<T extends RunOptions = RunOptions> {
...
export interface Deno {
     ...
     * @category I/O
     */
    stdin: Reader & ReaderSync & Closer & {
     ...
     * @category I/O
     */
    stdout: Writer & WriterSync & Closer & {
     ...
     * @category I/O
     */
    stderr: Writer & WriterSync & Closer & {
     ...
     * @category I/O
     */
    readAllSync(r: ReaderSync): Uint8Array;
     ...
     * @category Sub Process
     */
    run<T extends RunOptions = RunOptions>(opt: T): Process<T>;
