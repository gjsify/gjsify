...
// Based on https://github.com/denoland/deno/blob/main/ext/webidl/internal.d.ts
...
export namespace webidl {
  ...
  export interface ValueConverterOpts extends ConverterOpts {
    /**
  ...
  export interface IntConverterOpts extends ValueConverterOpts {
    /**
  ...
  export interface BufferConverterOpts extends ValueConverterOpts {
    /**
   ...
   */
  export function createDictionaryConverter<T>(
    name: string,
   ...
   */
  export function createEnumConverter(
    name: string,
    values: string[],
   ...
   */
  export function createNullableConverter<T>(
   ...
   */
  export function createSequenceConverter<T>(
    converter: (v: any, opts: ValueConverterOpts) => T,
  ): (v: any, opts: ValueConverterOpts) => T[];
   ...
   */
  export function createPromiseConverter<T>(
    converter: (v: any, opts: ValueConverterOpts) => T,
   ...
   */
  export function createBranded(self: any): any;

  /**
   * Assert that self is branded.
   */
  export function assertBranded(self: any, type: any): void;

  /**
   * Create a converter for interfaces.
   */
  export function createInterfaceConverter(
    name: string,
    prototype: any,
