...
import type { Listener, RunOptions, Process, Conn, Addr, ListenOptions, ConnectOptions, TcpConn, UnixConn, Signal } from './index.js'
 ...
 */
export type UmaskFn = (mask?: number) => number; // TODO function umask
 ...
 * @category FFI
 */
export interface UnsafePointer { // TODO class
 ...
 * @category FFI
 */
export interface UnsafePointerView { // TODO class
 ...
 * @category FFI
 */
export interface UnsafeFnPointer<Fn extends ForeignFunction> { // TODO class
 ...
 * @category FFI
 */
export interface UnsafeCallback< // TODO class
 ...
 * @category FFI
 */
export type DlopenFn = <S extends ForeignLibraryInterface>( // TODO function dlopen
    filename: string | URL,
    symbols: S,
) => DynamicLibrary<S>;
 ...
 */
export type RunFn = <T extends UnstableRunOptions = UnstableRunOptions>( // TODO function run
    opt: T,
) => Process<T>;
 ...
 * @category Fetch API
 */
export type CreateHttpClientFn = ( // TODO function createHttpClient
 ...
 * @category Network
 */
export type ListenFn2 = ( // TODO function listen
 ...
 * @category Network
 */
export type ListenDatagramFn1 = ( // TODO function listenDatagram
 ...
 * @category Network
 */
export type ListenDatagramFn2 = ( // TODO function listenDatagram
 ...
 * @category Network
 */
export type ConnectFn1 = (options: ConnectOptions) => Promise<TcpConn>; // TODO function connect
/** **UNSTABLE**: New API, yet to be vetted.
 *
 * Connects to the hostname (default is "127.0.0.1") and port on the named
 * transport (default is "tcp"), and resolves to the connection (`Conn`).
 ...
 * @category Network
 */
export type ConnectFn2 = (options: UnixConnectOptions) => Promise<UnixConn>; // TODO function connect
 ...
 * @category File System
 */
export type FlockFn = (rid: number, exclusive?: boolean) => Promise<void>; // TODO function flock
 ...
 * @category File System
 */
export type FlockSyncFn = (rid: number, exclusive?: boolean) => void; // TODO function flockSync
 ...
 * @category File System
 */
export type FunlockFn = (rid: number) => Promise<void>; // TODO function funlock
 ...
 * @category File System
 */
export type FunlockSyncFn = (rid: number) => void; // TODO function funlockSync
 ...
 * @category HTTP Server
 */
export interface ServeOptions extends Partial<ListenOptions> {
 ...
 * @category HTTP Server
 */
export type ServeFn1 = ( // TODO function serve
    handler: ServeHandler,
 ...
 * @category HTTP Server
 */
export type ServeFn2 = ( // TODO function serve
    options: ServeOptions | ServeTlsOptions,
    handler: ServeHandler,
) => Promise<void>;
/** **UNSTABLE**: New API, yet to be vetted.
 ...
 * @category HTTP Server
 */
export type ServeFn3 = ( // TODO function serve
 ...
 * @category HTTP Server
 */
export type UpgradeHttpFn = ( // TODO function upgradeHttp
    request: Request,
) => Promise<[Conn, Uint8Array]>;
 ...
 * @category HTTP Server
 */
export type upgradeHttpRaw = (request: Request) => [Conn, Uint8Array]; // TODO function upgradeHttpRaw
 ...
 * @category Sub Process
 */
export type SpawnChildFn = ( // TODO function spawnChild
    command: string | URL,
 ...
 * @category Sub Process
 */
export interface Child { // TODO class
 ...
 * @category Sub Process
 */
export type SpawnFn = ( // TODO function spawn
    command: string | URL,
    options?: SpawnOptions,
) => Promise<SpawnOutput>;
 ...
 * @category Sub Process
 */
export type SpawnSyncFn = ( // TODO function spawnSync
    command: string | URL,
    options?: SpawnOptions,
) => SpawnOutput;
 ...
 * @category Fetch API
 */
export type FetchFn = ( // TODO function fetch
 ...
 * @category Web Sockets
 */
export interface WebSocketStream { // TODO class
