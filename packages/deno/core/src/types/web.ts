...
/** @category DOM Events */
export interface DOMException extends Error { // TODO class
   ...
   * @category DOM Events
   */
  export interface Event { // TODO class
   ...
   * @category DOM Events
   */
  export interface EventTarget { // TODO class
   ...
   * @category DOM Events
   */
  export interface ProgressEvent<T extends EventTarget = EventTarget> extends Event { // TODO class
   ...
   */
  export type AtobFn = (s: string) => string; // TODO function atob
   ...
   * @category Encoding API
   */
  export type bBoaFn = (s: string) => string; // TODO function function btoa
   ...
   * @category Web APIs
   */
  export interface AbortController { // TODO class
   ...
   * @category Web File API
   */
  export interface Blob { // TODO class
   ...
   * @category Web File API
   */
  export interface File extends Blob { // TODO class
    // constructor(
    //   fileBits: BlobPart[],
    //   fileName: string,
  ...
  /** @category Streams API */
  export interface MessageEvent<T = any> extends Event { // TODO class
    /**
   ...
   * @category DOM APIs
   */
  export interface MessageChannel { // TODO class
    // constructor();
   ...
   * @category DOM APIs
   */
  export interface MessagePort extends EventTarget { // TODO class
   ...
   * @category DOM APIs
   */
  export type StructuredCloneFn = ( // TODO function structuredClone
    value: any,
   ...
   */
  export interface CompressionStream { // TODO class
    /**
   ...
   * @category Compression Streams API
   */
  export interface DecompressionStream { // TODO class
    /**
   ...
   * @category Web APIs
   */
  export type ReportErrorFn = ( // TODO function reportError
    error: any,
  ) => void;
