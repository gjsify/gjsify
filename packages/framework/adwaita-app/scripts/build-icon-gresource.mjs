...
${entries.map((rel) => `    <file preprocess="xml-stripblanks" compressed="true">${rel}</file>`).join('\n')}
  </gresource>
</gresources>
`;
...
const generated = `// icons.generated.ts — auto-generated by scripts/build-icon-gresource.mjs
...
export const BUNDLED_ICON_GRESOURCE_BASE64 =
    '${base64}';
`;
writeFileSync(join(pkgRoot, 'src/icons.generated.ts'), generated);
