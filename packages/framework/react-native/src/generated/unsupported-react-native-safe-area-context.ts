...
//
// One export per react-native-safe-area-context name this layer does not answer yet, each a value
...
export const SafeAreaInsetsContext = unsupported('SafeAreaInsetsContext', 'react-native-safe-area-context');
export const SafeAreaFrameContext = unsupported('SafeAreaFrameContext', 'react-native-safe-area-context');
export const withSafeAreaInsets = unsupported('withSafeAreaInsets', 'react-native-safe-area-context');
export const SafeAreaConsumer = unsupported('SafeAreaConsumer', 'react-native-safe-area-context');
