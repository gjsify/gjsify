...
//
// One export per expo-font name this layer does not answer yet, each a value
...
export const loadAsync = unsupported('loadAsync', 'expo-font');
export const unloadAsync = unsupported('unloadAsync', 'expo-font');
export const unloadAllAsync = unsupported('unloadAllAsync', 'expo-font');
export const FontDisplay = unsupported('FontDisplay', 'expo-font');
