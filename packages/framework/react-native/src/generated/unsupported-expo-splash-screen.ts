...
//
// One export per expo-splash-screen name this layer does not answer yet, each a value
...
export const preventAutoHideAsync = unsupported('preventAutoHideAsync', 'expo-splash-screen');
export const hideAsync = unsupported('hideAsync', 'expo-splash-screen');
export const hide = unsupported('hide', 'expo-splash-screen');
export const preventAutoHide = unsupported('preventAutoHide', 'expo-splash-screen');
export const setOptions = unsupported('setOptions', 'expo-splash-screen');
