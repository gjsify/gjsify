...
//
// One export per expo-image name this layer does not answer yet, each a value
...
export const Image = unsupported('Image', 'expo-image');
export const ImageBackground = unsupported('ImageBackground', 'expo-image');
export const useImage = unsupported('useImage', 'expo-image');
