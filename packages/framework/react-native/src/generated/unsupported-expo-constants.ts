...
//
// One export per expo-constants name this layer does not answer yet, each a value
...
export const ExecutionEnvironment = unsupported('ExecutionEnvironment', 'expo-constants');
export const AppOwnership = unsupported('AppOwnership', 'expo-constants');
...
// declares `export default unsupported('default', 'expo-constants')` instead.
