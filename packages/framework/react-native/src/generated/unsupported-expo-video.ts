...
//
// One export per expo-video name this layer does not answer yet, each a value
...
export const VideoView = unsupported('VideoView', 'expo-video');
export const useVideoPlayer = unsupported('useVideoPlayer', 'expo-video');
export const VideoContentFit = unsupported('VideoContentFit', 'expo-video');
