...
import type { JsxAttributes, WithOnce, WithPortableValues } from './attrs.js';
...
export type GtkIntrinsicElements = {
    [K in keyof WidgetPropsByTag]: WithOnce<WithPortableValues<WidgetPropsByTag[K]>> &
        JsxAttributes<WidgetClassByTag[K]>;
};
