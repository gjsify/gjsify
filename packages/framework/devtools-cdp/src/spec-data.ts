// AUTO-GENERATED by scripts/generate-spec-data.mjs — DO NOT EDIT BY HAND.
// A pruned snapshot of the WebKit Remote Inspector Protocol (refs/webkit). Re-run
// the generator + `oxfmt --write` after a protocol bump. 27 domains, 248 commands.

import type { ProtocolDomain } from './protocol-spec.js';

export const PROTOCOL_SOURCE = {
    generator: 'scripts/generate-spec-data.mjs',
    domains: 27,
    commands: 248,
} as const;

export const PROTOCOL_SPEC: ProtocolDomain[] = [
    {
        domain: 'Animation',
        types: [
            {
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        type: 'string',
                        optional: true,
                        description: 'Equal to `Animation.prototype.get id`.',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        optional: true,
                        description: 'Backtrace that was captured when this `WebAnimation` was created.',
                    },
                ],
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        type: 'number',
                        optional: true,
                        description: 'Index of which iteration to start at.',
                    },
                    {
                        name: 'iterationDuration',
                        type: 'number',
                        optional: true,
                        description: 'Total time of each iteration, measured in milliseconds.',
                    },
                    {
                        name: 'timingFunction',
                        type: 'string',
                        optional: true,
                        description: 'CSS timing function of the overall animation.',
                    },
                    {
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        type: 'string',
                        optional: true,
                        description: 'CSS timing function for how the `style` is applied.',
                    },
                    {
                        name: 'style',
                        type: 'string',
                        optional: true,
                        description: 'CSS style declaration of the CSS properties that will be animated.',
                    },
                ],
            },
            {
                ...
                returns: [
                    {
                        ...
                        $ref: 'Effect',
                        optional: true,
                        description: 'This is omitted when there is no effect.',
                    },
                ],
            },
            {
                ...
                properties: [
                    {
                        name: 'name',
                        type: 'string',
                        description: 'Some thread identification information.',
                    },
                    {
                        name: 'usage',
                        type: 'number',
    ...
    },
    {
        ...
        types: [
            ...
            },
            {
                ...
                type: 'string',
                enum: ['active', 'focus', 'focus-visible', 'focus-within', 'hover', 'target', 'visited'],
            },
            {
                id: 'PseudoIdMatches',
                type: 'object',
                ...
                properties: [
                    {
                        name: 'text',
                        type: 'string',
                        description: 'Canonicalized selector text.',
                    },
                    {
                        name: 'specificity',
                        type: 'array',
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        description: 'Other names for this property.',
                    },
                    {
                        name: 'longhands',
                        type: 'array',
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'Whether the property is able to be inherited.',
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                properties: [
                    ...
                    {
                        name: 'status',
                        $ref: 'CSSPropertyStatus',
                        optional: true,
                        description: 'Whether the property is active or disabled.',
                    },
                    {
                        name: 'range',
                        $ref: 'SourceRange',
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        type: 'string',
                        optional: true,
                        description: 'URL of the document containing the CSS grouping.',
                    },
                    {
                        name: 'range',
                        $ref: 'SourceRange',
                ...
                properties: [
                    {
                        name: 'displayName',
                        type: 'string',
                        description: 'The display name defined by the font.',
                    },
                    {
                        name: 'variationAxes',
                        type: 'array',
                        ...
                        description: 'The variation axes defined by the font.',
                    },
                    {
                        name: 'synthesizedBold',
                        type: 'boolean',
                        optional: true,
                        description: 'Whether the font has synthesized its boldness or not.',
                    },
                    {
                        name: 'synthesizedOblique',
                        type: 'boolean',
                        optional: true,
                        description: 'Whether the font has synthesized its obliqueness or not',
                    },
                ],
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        name: 'tag',
                        type: 'string',
                        description: 'The four character tag for the variation axis.',
                    },
                    {
                        name: 'minimumValue',
                        type: 'number',
                        description: 'The minimum value that will affect the axis.',
                    },
                    {
                        name: 'maximumValue',
                        type: 'number',
                        description: 'The maximum value that will affect the axis.',
                    },
                    {
                        name: 'defaultValue',
                        type: 'number',
                        description: 'The value that is used for the axis when it is not otherwise controlled.',
                    },
                ],
            },
            {
        ...
        commands: [
                ...
                returns: [
                    {
                        name: 'primaryFont',
                        $ref: 'Font',
                        description: 'Computed primary font for the specified DOM node.',
                    },
                ],
            },
            {
                ...
                returns: [
                    {
                        ...
                        description: 'Stylesheet contents for the specified <code>styleSheetId</code>.',
                    },
                ],
            },
            {
                ...
                returns: [
                    {
                        name: 'grouping',
                        $ref: 'Grouping',
                        description: 'The resulting grouping after the header text modification.',
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                returns: [
                    {
                        name: 'fontFamilyNames',
                        type: 'array',
                        items: {
                            type: 'string',
                        },
                        description: 'Supported system font families.',
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                parameters: [
                    {
                        name: 'mode',
                        $ref: 'LayoutContextTypeChangedMode',
                        description: 'The mode for how layout context type changes are handled.',
                    },
                ],
            },
        ],
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        optional: true,
                        description: 'Context attributes for rendering contexts.',
                    },
                    {
                        name: 'memoryCost',
                        type: 'number',
                        optional: true,
                        description: 'Memory usage of the canvas in bytes.',
                    },
                    {
                        name: 'stackTrace',
                        $ref: 'Console.StackTrace',
                        optional: true,
                        description: 'Backtrace that was captured when this canvas context was created.',
                    },
                ],
            },
            {
                ...
                returns: [
                    {
                        name: 'nodeId',
                        $ref: 'DOM.NodeId',
                        description: 'Node identifier for given canvas.',
                    },
                ],
            },
            {
                ...
                returns: [
                    {
                        name: 'content',
                        type: 'string',
                        description: "Base64-encoded data of the canvas' contents.",
                    },
                ],
            },
            {
                ...
                returns: [
                    {
                        name: 'object',
                        $ref: 'Runtime.RemoteObject',
                        description: 'JavaScript object wrapper for given canvas context.',
                    },
                ],
            },
            {
                ...
                parameters: [
                    {
                        name: 'count',
                        type: 'integer',
                        description: "Number of frames to record (0 means don't record anything).",
                    },
                ],
            },
            {
                ...
                parameters: [
                    ...
                    },
                    {
                        ...
                        type: 'integer',
                        optional: true,
                        description: 'Number of frames to record (unlimited when not specified).',
                    },
                    {
                        name: 'memoryLimit',
                        type: 'integer',
                        optional: true,
                        description: 'Memory limit of recorded data (100MB when not specified).',
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        $ref: 'Network.FrameId',
                        optional: true,
                        description: 'Identifier of the containing frame.',
                    },
                    {
                        name: 'childNodeCount',
                        type: 'integer',
                    ...
                    {
                        name: 'customElementState',
                        $ref: 'CustomElementState',
                        optional: true,
                ...
                properties: [
                    {
                        name: 'binding',
                        type: 'string',
                        description: 'The binding key that is specified.',
                    },
                    {
                        name: 'type',
                        type: 'string',
                    ...
                    },
                    {
                        name: 'value',
                        type: 'string',
                        description: 'The value that is resolved to with this data binding relationship.',
                    },
                ],
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        $ref: 'NodeId',
                        optional: true,
                        description: 'The target <code>DOMNode</code> id if the event listener is for a node.',
                    },
                    {
                        name: 'onWindow',
                        type: 'boolean',
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        description: 'Array of <code>DOMNode</code> ids of any nodes referenced via @aria-controls.',
                    },
                    {
                        name: 'current',
                        type: 'string',
                        optional: true,
                        enum: ['true', 'false', 'page', 'step', 'location', 'date', 'time'],
                    ...
                    },
                    {
                        ...
                        type: 'number',
                        optional: true,
                        description: 'Heading level of a heading element.',
                    },
                    {
                        name: 'hierarchyLevel',
                        type: 'number',
                        optional: true,
                        description: 'The hierarchical level of an element.',
                    },
                    {
                        name: 'isPopUpButton',
                        type: 'boolean',
                        optional: true,
                        description: 'Whether an element is a popup button.',
                    },
                    {
                        name: 'exists',
                        type: 'boolean',
                    ...
                    },
                    {
                        ...
                        description: 'Array of <code>DOMNode</code> ids of any nodes referenced via @aria-flowto.',
                    },
                    {
                        name: 'focused',
                        type: 'boolean',
                    ...
                    },
                    {
                        ...
                        description: 'Array of <code>DOMNode</code> ids of any nodes referenced via @aria-owns.',
                    },
                    {
                        name: 'parentNodeId',
                        $ref: 'NodeId',
                        optional: true,
                        description: '<code>DOMNode</code> id of the accessibility tree parent object if available.',
                    },
                    {
                        name: 'pressed',
                        type: 'boolean',
                    ...
                    },
                    {
                        ...
                        description: 'Array of <code>DOMNode</code> ids of any children marked as selected.',
                    },
                    {
                        name: 'switchState',
                        type: 'string',
                        optional: true,
                        enum: ['off', 'on'],
                        description: 'On / off state of switch form controls.',
                    },
                ],
            },
            {
                ...
                properties: [
                    {
                        name: 'gridColor',
                        $ref: 'RGBAColor',
                        description: 'The primary color to use for the grid overlay.',
                    },
                    {
                        name: 'showLineNames',
                        type: 'boolean',
                        optional: true,
                        description: 'Show labels for grid line names. If not specified, the default value is false.',
                    },
                    {
                        name: 'showLineNumbers',
                        type: 'boolean',
                        optional: true,
                        description: 'Show labels for grid line numbers. If not specified, the default value is false.',
                    },
                    {
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'Show grid track size information. If not specified, the default value is false.',
                    },
                    {
                        name: 'showAreaNames',
                        type: 'boolean',
                        optional: true,
                        description: 'Show labels for grid area names. If not specified, the default value is false.',
                    },
                    {
                        name: 'showOrderNumbers',
                        type: 'boolean',
                        optional: true,
                        description: 'Show labels for grid item order. If not specified, the default value is false.',
                    },
                ],
            },
            {
                ...
                properties: [
                    {
                        name: 'flexColor',
                        $ref: 'RGBAColor',
                        description: 'The primary color to use for the flex overlay.',
                    },
                    {
                        name: 'showOrderNumbers',
                        type: 'boolean',
                        optional: true,
                        description: 'Show labels for flex order. If not specified, the default value is false.',
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        type: 'number',
                        optional: true,
                        description: 'The ratio between physical screen pixels and CSS pixels.',
                    },
                    {
                        name: 'viewport',
                        $ref: 'ViewportSize',
                        optional: true,
                        description: 'The viewport size occupied by the media element.',
                    },
                    {
                        name: 'quality',
                    ...
                    },
                    {
                        ...
                        type: 'string',
                        optional: true,
                        description: 'The source type of the media element.',
                    },
                ],
            },
            {
                ...
                properties: [
                    {
                        name: 'bitrate',
                        type: 'integer',
                        description: 'The data rate of the primary audio track in bits/s.',
                    },
                    {
                        name: 'codec',
                        type: 'string',
                        description: 'The codec string of the primary audio track. (E.g., "hvc1.1.6.L123.B0")',
                    },
                    {
                        name: 'humanReadableCodecString',
                        type: 'string',
                        description: 'A human readable version of the `codec` parameter.',
                    },
                    {
                        name: 'numberOfChannels',
                        type: 'integer',
                        description: 'The number of audio channels in the primary audio track.',
                    },
                    {
                        name: 'sampleRate',
                        type: 'number',
                        description: 'The sample rate of the primary audio track in hertz.',
                    },
                    {
                        name: 'isProtected',
                        type: 'boolean',
                        optional: true,
                        description: 'Whether the track contains protected contents',
                    },
                ],
            },
            {
                ...
                properties: [
                    {
                        name: 'bitrate',
                        type: 'integer',
                        description: 'The data rate of the video track in bits/s.',
                    },
                    {
                        name: 'codec',
                        type: 'string',
                        description: 'The codec string of the video track. (E.g., "hvc1.1.6.L123.B0")',
                    },
                    {
                        name: 'humanReadableCodecString',
                        type: 'string',
                    ...
                    },
                    {
                        name: 'framerate',
                        type: 'number',
                        description: 'The nominal frame rate of video track in frames per second.',
                    },
                    {
                        name: 'height',
                        type: 'integer',
                        description: 'The native height of the video track in CSS pixels',
                    },
                    {
                        name: 'width',
                        type: 'integer',
                        description: 'The native width of the video track in CSS pixels',
                    },
                    {
                        name: 'immersiveVideoMetadata',
                        $ref: 'ImmersiveVideoMetadata',
                        optional: true,
                    },
                    {
                        name: 'isProtected',
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        type: 'string',
                        optional: true,
                        description: 'The matrix specification of the colorspace',
                    },
                    {
                        name: 'primaries',
                        type: 'string',
                        optional: true,
                        description: 'The color primaries specification of the colorspace',
                    },
                    {
                        name: 'transfer',
                        type: 'string',
                        optional: true,
                        description: 'The transfer function specification of the colorspace',
                    },
                ],
            },
            {
                ...
                properties: [
                    {
                        name: 'displayCompositedVideoFrames',
                        type: 'integer',
                        description: 'The number of frames of the total which were composited by the display.',
                    },
                    {
                        name: 'droppedVideoFrames',
                        type: 'integer',
                        description: 'The number of frames of the total which were dropped without being displayed.',
                    },
                    {
                        name: 'totalVideoFrames',
                        type: 'integer',
                        description: 'The total number of frames enqueued for display by the media element.',
                    },
                ],
            },
            {
                id: 'ImmersiveVideoMetadata',
                type: 'object',
                properties: [
                    {
                        name: 'kind',
                        $ref: 'VideoProjectionMetadataKind',
                        description: 'The kind of immersive video.',
                    },
                    {
                        name: 'width',
                        type: 'number',
                    ...
                    },
                    {
                        ...
                        type: 'integer',
                        optional: true,
                        description: 'The horizontal field-of-view measurement, in degrees',
                    },
                    {
                        name: 'stereoCameraBaseline',
                        type: 'integer',
                        optional: true,
                        description:
                    ...
                    {
                        name: 'horizontalDisparityAdjustment',
                        type: 'integer',
                        optional: true,
                        description: 'The relative shift of the left and right eye images, as a percentage',
                    },
                ],
            },
            {
        ...
        commands: [
                ...
                parameters: [
                    {
                        name: 'nodeId',
                        $ref: 'NodeId',
                        description: 'Id of the node to get data bindings for.',
                    },
                ],
                returns: [
                    {
                        ...
                        description: 'Array of binding relationships between data and node',
                    },
                ],
            },
            {
                ...
                parameters: [
                    {
                        name: 'nodeId',
                        $ref: 'NodeId',
                        description: 'Id of the node to get associated data for.',
                    },
                ],
                returns: [
                    {
                        ...
                        type: 'string',
                        optional: true,
                        description: 'Associated data bound to this node. Sent as a JSON string.',
                    },
                ],
            },
            {
                ...
                parameters: [
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'Controls whether ancestor event listeners are included. Defaults to true.',
                    },
                ],
                returns: [
                    {
            ...
            },
            {
                ...
                parameters: [
                    ...
                    {
                        name: 'options',
                        $ref: 'Debugger.BreakpointOptions',
                        optional: true,
                ...
                parameters: [
                    {
                        name: 'nodeId',
                        $ref: 'NodeId',
                        description: 'Id of the node for which to get accessibility properties.',
                    },
                ],
                returns: [
                    {
                        name: 'properties',
                        $ref: 'AccessibilityProperties',
                        description: 'Dictionary of relevant accessibility properties.',
                    },
                ],
            },
            {
                ...
                parameters: [
                    {
                        name: 'selectorString',
                        type: 'string',
                        description: 'A CSS selector for finding matching nodes to highlight.',
                    },
                    {
                        name: 'frameId',
                        type: 'string',
                ...
                parameters: [
                    {
                        name: 'nodeId',
                        $ref: 'NodeId',
                        description: 'The node for which a grid overlay should be shown.',
                    },
                    {
                        name: 'gridOverlayConfig',
                        $ref: 'GridOverlayConfig',
                        description: 'Configuration options for the grid overlay.',
                    },
                ],
            },
            {
                ...
                parameters: [
                    {
                        name: 'nodeId',
                        $ref: 'NodeId',
                        description: 'The node for which a flex overlay should be shown.',
                    },
                    {
                        name: 'flexOverlayConfig',
                        $ref: 'FlexOverlayConfig',
                        description: 'Configuration options for the flex overlay.',
                    },
                ],
            },
            {
                ...
                parameters: [
                    {
                        name: 'nodeId',
                        $ref: 'NodeId',
                        description: 'DOM node id to be accessible by means of $0 command line API.',
                    },
                ],
            },
            {
                ...
                parameters: [
                    {
                        name: 'nodeId',
                        $ref: 'NodeId',
                        description: 'Id of the node to retrieve mediastats for.',
                    },
                ],
                returns: [
                    {
        ...
        commands: [
            ...
            },
            {
                ...
                parameters: [
                    {
                        name: 'breakpointType',
                        $ref: 'EventBreakpointType',
                    },
                    {
                        name: 'eventName',
                        type: 'string',
                        optional: true,
                        description: 'The name of the specific event to stop on.',
                    },
                    {
                        name: 'caseSensitive',
                        type: 'boolean',
                        optional: true,
                        description: 'If true, eventName is case sensitive. Defaults to true.',
                    },
                    {
                        name: 'isRegex',
                        type: 'boolean',
                        optional: true,
                        description: 'If true, treats eventName as a regex. Defaults to false.',
                    },
                    {
                        name: 'options',
                        $ref: 'Debugger.BreakpointOptions',
            ...
            },
            {
                ...
                parameters: [
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'Whether the URL string is a regular expression.',
                    },
                    {
                        name: 'options',
                        $ref: 'Debugger.BreakpointOptions',
                ...
                parameters: [
                    {
                        name: 'url',
                        type: 'string',
                        description: 'Resource URL substring. An empty string will stop pausing on all requests.',
                    },
                    {
                        name: 'isRegex',
                        type: 'boolean',
            ...
            },
            {
                ...
                parameters: [
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'If <code>true</code>, <code>url</code> is case sensitive. Defaults to true.',
                    },
                    {
                        name: 'isRegex',
                        type: 'boolean',
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        name: 'width',
                        type: 'integer',
                        description: 'The width metric.',
                    },
                    {
                        name: 'height',
                        type: 'integer',
                        description: 'The height metric.',
                    },
                ],
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        name: 'bounds',
                        $ref: 'IntRect',
                        description: 'Bounds of the layer in absolute page coordinates.',
                    },
                    {
                        name: 'paintCount',
                        type: 'integer',
                    ...
                    },
                    {
                        name: 'memory',
                        type: 'integer',
                        description: 'Estimated memory used by this layer.',
                    },
                    {
                        name: 'compositedBounds',
                        $ref: 'IntRect',
                        description: 'The bounds of the composited layer.',
                    },
                    {
                        name: 'isInShadowTree',
                        type: 'boolean',
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'Indicates whether this layer was used to provide a reflection for the element.',
                    },
                    {
                        name: 'isGeneratedContent',
                        type: 'boolean',
                        optional: true,
                        description:
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'Indicates whether the layer was created for a CSS anonymous block or box.',
                    },
                    {
                        name: 'pseudoElementId',
                        $ref: 'PseudoElementId',
                        optional: true,
                        description: 'The id for the pseudo element associated with this layer.',
                    },
                    {
                        name: 'pseudoElement',
                        type: 'string',
                ...
                properties: [
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an element with a CSS 3D transform.',
                    },
                    {
                        name: 'video',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with a <video> element.',
                    },
                    {
                        name: 'canvas',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to the element being a <canvas> element.',
                    },
                    {
                        name: 'plugin',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with a plugin.',
                    },
                    {
                        name: 'iFrame',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an <iframe> element.',
                    },
                    {
                        name: 'model',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with a <model> element.',
                    },
                    {
                        name: 'backfaceVisibilityHidden',
                        type: 'boolean',
                        optional: true,
                        description:
                    ...
                    {
                        name: 'clipsCompositingDescendants',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an element clipping compositing descendants.',
                    },
                    {
                        name: 'animation',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an animated element.',
                    },
                    {
                        name: 'filters',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an element with CSS filters applied.',
                    },
                    {
                        name: 'positionFixed',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an element with a "position: fixed" style.',
                    },
                    {
                        name: 'positionSticky',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an element with a "position: sticky" style.',
                    },
                    {
                        name: 'overflowScrollingTouch',
                        type: 'boolean',
                        optional: true,
                        description:
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an element establishing a stacking context.',
                    },
                    {
                        name: 'overlap',
                        type: 'boolean',
                    ...
                    {
                        name: 'transformWithCompositedDescendants',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an element with composited descendants.',
                    },
                    {
                        name: 'opacityWithCompositedDescendants',
                        type: 'boolean',
                        optional: true,
                        description:
                    ...
                    {
                        name: 'maskWithCompositedDescendants',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with a masked element and composited descendants.',
                    },
                    {
                        name: 'reflectionWithCompositedDescendants',
                        type: 'boolean',
                        optional: true,
                        description:
                    ...
                    {
                        name: 'filterWithCompositedDescendants',
                        type: 'boolean',
                        optional: true,
                        description:
                    ...
                    {
                        name: 'blendingWithCompositedDescendants',
                        type: 'boolean',
                        optional: true,
                        description:
                    ...
                    {
                        name: 'isolatesCompositedBlendingDescendants',
                        type: 'boolean',
                        optional: true,
                        description:
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an element with perspective applied.',
                    },
                    {
                        name: 'preserve3D',
                        type: 'boolean',
                    ...
                    },
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an element with a "will-change" style.',
                    },
                    {
                        name: 'root',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with the root element.',
                    },
                    {
                        name: 'blending',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an element with a "blend-mode" style.',
                    },
                    {
                        name: 'backdropRoot',
                        type: 'boolean',
                        optional: true,
                        description: 'Composition due to association with an element that is a backdrop root',
                    },
                ],
            },
        ],
                ...
                parameters: [
                    {
                        name: 'nodeId',
                        $ref: 'DOM.NodeId',
                        description: 'Root of the subtree for which we want to gather layers.',
                    },
                ],
                returns: [
                    {
                ...
                parameters: [
                    {
                        name: 'layerId',
                        $ref: 'LayerId',
                        description: 'The id of the layer to snapshot.',
                    },
                ],
                returns: [
                    {
                        name: 'content',
                        type: 'string',
                        description: "Base64-encoded PNG data URL of the layer's rendered content.",
                    },
                ],
            },
        ],
        ...
        types: [
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        description: 'Breakdown of memory in categories.',
                    },
                ],
            },
            {
                ...
                properties: [
                    {
                        name: 'type',
                        type: 'string',
                        enum: ['javascript', 'jit', 'images', 'layers', 'page', 'other'],
                        description: 'Category type.',
                    },
                    {
                        name: 'size',
                        type: 'number',
                        description: 'Category size in bytes.',
                    },
                ],
            },
        ],
                ...
                properties: [
                    {
                        name: 'startTime',
                        $ref: 'Timestamp',
                        description: 'Request is initiated',
                    },
                    {
                        name: 'redirectStart',
                        $ref: 'Timestamp',
                        description: 'Started redirect resolution.',
                    },
                    {
                        name: 'redirectEnd',
                        $ref: 'Timestamp',
                        description: 'Finished redirect resolution.',
                    },
                    {
                        name: 'fetchStart',
                        $ref: 'Timestamp',
                        description: 'Resource fetching started.',
                    },
                    {
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        name: 'payloadLength',
                        type: 'number',
                        description: 'WebSocket frame payload length in bytes.',
                    },
                ],
            },
            {
                ...
                parameters: [
                    {
                        name: 'disabled',
                        type: 'boolean',
                        description: 'Whether to prevent usage of the resource cache.',
                    },
                ],
            },
            {
                ...
                parameters: [
                    {
                        name: 'clearResourceDataOnNavigate',
                        type: 'boolean',
                        description: 'Whether to clear resource data on navigations.',
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                parameters: [
                    ...
                    },
                    {
                        name: 'stage',
                        $ref: 'NetworkStage',
                        description: 'Stage to intercept.',
                    },
                    {
                        name: 'caseSensitive',
                        type: 'boolean',
        ...
        types: [
            ...
            },
            {
                ...
                properties: [
                    {
                        name: 'name',
                        $ref: 'UserPreferenceName',
                        description: 'Preference name.',
                    },
                    {
                        name: 'value',
                        $ref: 'UserPreferenceValue',
        ...
        commands: [
                ...
                parameters: [
                    {
                        ...
                        type: 'boolean',
                        optional: true,
                        description: 'If true, the page is reloaded from its origin without using cached resources.',
                    },
                    {
                        name: 'revalidateAllResources',
                        type: 'boolean',
                        optional: true,
                        description:
            ...
            },
            {
                ...
                parameters: [
                    ...
                    {
                        name: 'shouldPartition',
                        type: 'boolean',
                        optional: true,
                        description: "If true, then cookie's partition key should be set.",
                    },
                ],
            },
            {
                ...
                parameters: [
                    ...
                    },
                    {
                        name: 'url',
                        type: 'string',
                        description: 'URL to match cookie domain and path.',
                    },
                ],
            },
            {
                ...
                parameters: [
                    {
                        name: 'result',
                        type: 'boolean',
                        description: 'True for showing rulers',
                    },
                ],
            },
            {
                ...
                parameters: [
                    {
                        name: 'nodeId',
                        $ref: 'DOM.NodeId',
                        description: 'Id of the node to snapshot.',
                    },
                ],
                returns: [
                    {
            ...
            },
            {
                ...
                parameters: [
                    ...
                    },
                    {
                        ...
                        description: 'Indicates the coordinate system of the supplied rectangle.',
                    },
                ],
                returns: [
                    {
                ...
                returns: [
                    {
                        name: 'data',
                        type: 'string',
                        description: 'Base64-encoded web archive.',
                    },
                ],
            },
            {
                ...
                properties: [
                    {
                        ...
                        type: 'object',
                        optional: true,
                        description: 'Key-value map for each attribute of the state.',
                    },
                    {
                        name: 'states',
                        type: 'array',
                        ...
                        description: 'Array of saved states of the context.',
                    },
                    {
                        name: 'parameters',
                        type: 'array',
                        ...
                        description: 'Array of values that were used to construct the recorded object.',
                    },
                    {
                        name: 'content',
                        type: 'string',
                        optional: true,
                        description: 'Current content at the start of the recording.',
                    },
                ],
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        type: 'number',
                        optional: true,
                        description: 'Total execution time of all actions recorded in this frame in milliseconds. ',
                    },
                    {
                        name: 'incomplete',
                        type: 'boolean',
                        optional: true,
                        description: 'Flag indicating if the recording was stopped before this frame ended.',
                    },
                ],
            },
            {
                ...
                properties: [
                    {
                        name: 'version',
                        type: 'integer',
                        description: 'Used for future/backwards compatibility.',
                    },
                    {
                        name: 'type',
                        $ref: 'Type',
                    },
                    {
                        name: 'initialState',
                        $ref: 'InitialState',
                        description: 'JSON data of inital state of object before recording.',
                    },
                    {
                        name: 'data',
                        type: 'array',
            ...
            },
            {
                ...
                properties: [
                    ...
                    },
                    {
                        ...
                        description: 'DNS names listed on the certificate.',
                    },
                    {
                        name: 'ipAddresses',
                        type: 'array',
                        ...
                        description: 'IP addresses listed on the certificate.',
                    },
                ],
            },
            {
        ...
        types: [
            {
                ...
                properties: [
                    ...
                    },
                    {
                        name: 'url',
                        type: 'string',
                        description: 'ServiceWorker main script URL.',
                    },
                    {
                        name: 'content',
                        type: 'string',
                        description: 'ServiceWorker main script content.',
                    },
                ],
            },
        ],
        ...
        types: [
            {
                ...
                properties: [
                    ...
                    },
                    {
                        name: 'type',
                        type: 'string',
                        enum: ['page', 'frame', 'service-worker', 'worker'],
                    },
                    {
                        name: 'isProvisional',
                        type: 'boolean',
                        optional: true,
                        description: 'Whether this is a provisional page target.',
                    },
                    {
                        name: 'isPaused',
                        type: 'boolean',
                ...
                parameters: [
                    {
                        name: 'pauseOnStart',
                        type: 'boolean',
                        description: 'If set to true, new targets will be paused on start waiting for resume command.',
                    },
                ],
            },
            {
            ...
            },
            {
                ...
                parameters: [
                    ...
                    },
                    {
                        name: 'message',
                        type: 'string',
                        description: 'JSON Inspector Protocol message (command) to be dispatched on the backend.',
                    },
                ],
            },
        ],
    },
    {
        ...
        types: [
            ...
            },
            {
                id: 'Instrument',
                type: 'string',
                enum: ['ScriptProfiler', 'Timeline', 'CPU', 'Memory', 'Heap', 'Animation', 'Screenshot'],
            },
            {
                id: 'TimelineEvent',
                type: 'object',
                ...
                parameters: [
                    {
                        name: 'enabled',
                        type: 'boolean',
                        description: 'New auto capture state.',
                    },
                ],
            },
            {
                ...
                parameters: [
                    {
                        ...
                        description: 'Instruments to enable.',
                    },
                ],
            },
        ],
