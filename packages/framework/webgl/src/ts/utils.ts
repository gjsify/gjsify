...
export function bindPublics(
    props: Array<keyof WebGLContextBase>,
    wrapper: WebGLContextBase,
    privateInstance: WebGLContextBase,
...
export const extractImageData = (pixels: TexImageSource | HTMLImageElement): ImageData | null => {
    ...
    if (typeof pixels === 'object' && typeof width !== 'undefined' && typeof height !== 'undefined') {
        ...
        if (typeof (pixels as HTMLCanvasElement).getContext === 'function') {
            ...
            typeof (pixels as HTMLImageElement).isPixbuf === 'function' &&
            (pixels as HTMLImageElement).isPixbuf()
        ) {
            return (pixels as HTMLImageElement).getImageData();
        } else if (
            typeof (pixels as HTMLImageElement).src !== 'undefined' &&
...
export function convertPixels(
    pixels: ArrayBuffer | Uint8Array | Uint16Array | Uint8ClampedArray | Float32Array | Buffer | ArrayBufferView | null,
) {
