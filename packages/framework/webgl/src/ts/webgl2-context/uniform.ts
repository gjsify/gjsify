...
const uniformMethods: UniformMethods & ThisType<WebGL2RenderingContext> = {
    ...
    uniform1uiv(
        ...
        // TODO(open-todos: small API gaps): update @girs/gwebgl-0.1 types to accept Uint32Array; cast until then
    ...
    uniformMatrix2x3fv(
        ...
        // TODO(open-todos: small API gaps): update @girs/gwebgl-0.1 types to accept Float32Array; cast until then
