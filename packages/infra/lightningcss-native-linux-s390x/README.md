# @gjsify/lightningcss-native-linux-s390x


The **linux-s390x** native artifacts of [`@gjsify/lightningcss-native`](https://www.npmjs.com/package/@gjsify/lightningcss-native) — a shared
...
`cpu: ["s390x"]`, so your package manager installs the one build that fits your
