...
var globToEntryPoints = async (_entryPoints, ignore = []) => {
  if (Array.isArray(_entryPoints) && typeof _entryPoints[0] === "string") {
    return await (0, import_fast_glob.default)(_entryPoints, { ignore });
  } else if (Array.isArray(_entryPoints) && typeof _entryPoints[0] === "object") {
    const entryPoints2 = [];
    for (const entryPoint of _entryPoints) {
      const inputs = await (0, import_fast_glob.default)(entryPoint.in, { ignore });
  ...
  for (const input in _entryPoints) {
    ...
    const inputs = await (0, import_fast_glob.default)(input, { ignore });
...
import { dirname, resolve as resolve2, join } from "path";
