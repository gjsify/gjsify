...
// classes — which is also why most of the thirty-three now project with NO loss at all, where
...
// thirty-three files are about twenty-eight distinct SHAPES: the three `templates/adw-*/src/main-window.blp`
...
export const CORPUS_REAL_FILES = [
    ...
    {
        slug: 'packages_web_adwaita-core_src_conformance_blueprints_bottom-sheet-layout',
        source: 'packages/web/adwaita-core/src/conformance/blueprints/bottom-sheet-layout.blp',
    },
    {
