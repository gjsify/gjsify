...
export const REAL_EXPECTATIONS = [
    ...
    },
    {
        ...
        note: 'The first probe that is neither Adwaita nor a showcase: plain `Gtk.ApplicationWindow`, `child:` rather than `content:`, and the only real file whose caption is the POINT — it was converted from a TypeScript `new Gtk.Label({ label: ... })` that xgettext could not see. Dropping the marking here turned the conversion back into the thing it replaced, which is the argument ADR 0067 § 2 makes from this one line; what is left between this file and a lossless projection is the style class.',
    },
];
