# @gjsify/lightningcss-native-linux-x64

The **linux-x64** native artifacts of [`@gjsify/lightningcss-native`](https://www.npmjs.com/package/@gjsify/lightningcss-native) — a shared
