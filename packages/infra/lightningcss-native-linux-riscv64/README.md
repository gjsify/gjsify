# @gjsify/lightningcss-native-linux-riscv64

The **linux-riscv64** native artifacts of [`@gjsify/lightningcss-native`](https://www.npmjs.com/package/@gjsify/lightningcss-native) — a shared
...
`cpu: ["riscv64"]`, so your package manager installs the one build that fits your
