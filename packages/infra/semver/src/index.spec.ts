...
import { SemVer, Range, parse, valid, compare, satisfies, maxSatisfying, minSatisfying, validRange } from './index.js';
...
export default async () => {
    ...
    await describe('@gjsify/semver — maxSatisfying / minSatisfying', async () => {
        const versions = ['0.0.1', '0.1.0', '0.3.6', '0.3.7', '0.3.7-rc.1', '1.0.0', '1.2.3', '2.0.0-rc.1', '2.0.0'];
