# @gjsify/lightningcss-native-darwin-x64
...
The **darwin-x64** native artifacts of [`@gjsify/lightningcss-native`](https://www.npmjs.com/package/@gjsify/lightningcss-native) — a shared
...
You do not install this directly. `@gjsify/lightningcss-native` declares it as an
