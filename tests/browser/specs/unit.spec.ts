...
for (const bundle of bundles) {
    test(`${bundle.pillar}/@gjsify/${bundle.packageName} — browser unit tests`, async ({ page }) => {
        ...
        // passes — measured through this harness. A floor cannot see a PARTIAL shrink; that is
        // `scripts/check-browser-test-registration.mjs`, and the rest of the residual is in main.yml.
