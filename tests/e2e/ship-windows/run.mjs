 ...
 * refusal and one of the cases below drives it.
 */
const ARCH = 'x64';
 ...
 */
function closureFiles(arch = ARCH) {
 ...
 */
function installRuntimePackages(projectDir, { closure = true, interpreter = true, addon = true, arch = ARCH } = {}) {
