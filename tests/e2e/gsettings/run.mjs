...
describe('CLI gsettings E2E', { timeout: 10 * 60 * 1000 }, () => {
    ...
    before(() => {
        ...
        writeFileSync(join(projectDir, 'data', 'org.example.gschema.xml'), SCHEMA_XML);
    ...
    it('honours --targetdir', (t) => {
        ...
        assert.ok(existsSync(join(out, 'gschemas.compiled')), 'gschemas.compiled missing in --targetdir');
    });
});
