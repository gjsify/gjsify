...
describe('CLI config E2E', { timeout: 10 * 60 * 1000 }, () => {
    ...
    it('merges package.json#gjsify with .gjsifyrc.js', () => {
        writeFileSync(join(projectDir, 'src', 'app.ts'), "console.log('built via merged config');\n");
        writeFileSync(join(projectDir, '.gjsifyrc.js'), "export default { esbuild: { outfile: 'dist/merged.js' } };\n");
