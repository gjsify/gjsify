...
describe('CLI asset-loader E2E', { timeout: 10 * 60 * 1000 }, () => {
    ...
    before(() => {
        ...
        writeFileSync(join(projectDir, 'src', 'asm', 'demo.asm'), 'LDA #$ff   ; assembler-fixture-byte-marker\n');
        writeFileSync(
    ...
    it('inlines .png as a data:image/png;base64,... string default export', () => {
        ...
        assert.match(out, new RegExp(MINIMAL_PNG_B64.slice(0, 20)), 'PNG base64 payload mismatch');
    });
