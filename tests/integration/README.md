...
| `effect/` | Effect 4's fiber runtime end to end — `@gjsify/{timers,process,fs,path,abort-controller}` under the hardest scheduling consumer in the tree, incl. 21 upstream `FileSystem` conformance cases | `### effect` |
