...
export abstract class AudioManager {
    static levels = new Map<ex.Sound, number>([
        [Resources.music.stage1, 0.1],
        [Resources.music.stage2, 0.1],
        [Resources.sfx.jump, 0.25],
        [Resources.sfx.jumpSpring, 0.25],
        [Resources.sfx.land, 0.25],
        [Resources.sfx.turnAround, 0.25],
        [Resources.sfx.stomp, 0.25],
        [Resources.sfx.damage, 0.25],
        [Resources.sfx.collectCoin, 0.25],
    ]);
