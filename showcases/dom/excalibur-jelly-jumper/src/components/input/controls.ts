...
export class ControlsComponent extends ex.Component {
    ...
    isHeld(control: keyof typeof this.controls) {
        ...
        return Boolean(engine.input.keyboard.isHeld(key) || this.getGamepad()?.isButtonHeld(button));
    }
    ...
    wasPressed(control: keyof typeof this.controls) {
        ...
        return Boolean(engine.input.keyboard.wasPressed(key) || this.getGamepad()?.wasButtonPressed(button));
    }
    ...
    wasReleased(control: keyof typeof this.controls) {
        ...
        return Boolean(engine.input.keyboard.wasReleased(key) || this.getGamepad()?.wasButtonReleased(button));
    }
