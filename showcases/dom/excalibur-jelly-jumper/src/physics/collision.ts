...
export const CollisionGroup = {
    ...
    Enemy: new ex.CollisionGroup('enemy', Category.Enemy, collideWith(Category.Ground, Category.Player)),
    Hazard: new ex.CollisionGroup('hazard', Category.Hazard, collideWith(Category.Player)),
    Item: new ex.CollisionGroup('item', Category.Item, collideWith(Category.Player)),
    PhysicalItem: new ex.CollisionGroup(
        'phys-item',
        Category.PhysicalItem,
        collideWith(Category.Ground, Category.Player),
    ),
    Climbable: new ex.CollisionGroup('climbable', Category.Climbable, collideWith(Category.Player)),
};
