...
export type BirdEnemyArgs = ex.ActorArgs & {
...
export class BirdEnemy extends EnemyActor {
    ...
    constructor(args: BirdEnemyArgs) {
        ...
        this.graphics.use(ex.Animation.fromSpriteSheet(this.spritesheet, [0, 1, 2], 3000 / this.speed));
    ...
    onPreUpdate(engine: ex.Engine, elapsed: number): void {
        ...
        if (this.dead && this.deathPosition) {
            ...
            this.pos.y += Math.sin((this.elapsedMs / (this.speed * 10)) * Math.PI) * 0.3;
        }
