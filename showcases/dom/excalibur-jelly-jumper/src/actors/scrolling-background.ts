...
export class ScrollingBackground extends ex.Entity {
    ...
    constructor(args: { image: ex.ImageSource; xSpeed?: number; ySpeed?: number; z?: number }) {
    ...
    onInitialize(_engine: ex.Engine): void {
        ...
        this.on('pretransformdraw', () => {
            ...
            const xOffset = ((cameraLeft * -this.xSpeed) % sprite.width) + sprite.width;

            const yOffset = ((cameraTop * -this.ySpeed) % sprite.height) + sprite.height;
