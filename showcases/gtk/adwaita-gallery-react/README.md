# adwaita-gallery-react

Every block of the [Adwaita documentation gallery](../../../website/src/content/docs/adwaita) that
can be written as a static widget tree, **rendered through React** — JSX through a real `HostConfig`, compiled by
gtk-host's own automatic JSX runtime + `react-reconciler` — and asserted against the real GTK widget tree.
